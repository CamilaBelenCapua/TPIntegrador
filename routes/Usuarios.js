...
router.post('/usuarios/agregarAlumno', async(req, res) => {
    try{
...
router.post('/usuarios/agregarProfesor', async(req, res) => {
    try{
...
router.put('/usuarios/actualizarAlumno/:id', async(req,res)=>{
    try{
...
router.delete('/usuarios/borrarAlumno/:id', async(req,res)=>{
    try{
...
router.get('/usuarios/listarAlumnos', async (req, res) => {    
    try{
