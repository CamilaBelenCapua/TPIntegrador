...
router.get('/usuarios/consultarUsuarioPorMail/:email',auth, async (req, res) => {
    try{   
...
router.get('/usuarios/consultarUsuario/:id',auth, async (req, res) => {
    try{
...
router.post('/usuarios/agregarAlumno', auth, async(req, res) => {
    try{
...
router.post('/usuarios/agregarProfesor',auth, async(req, res) => {
    try{
...
router.put('/usuarios/actualizarAlumno/:id',auth, async(req,res)=>{
    try{
...
router.delete('/usuarios/borrarAlumno/:id',auth, async(req,res)=>{
    try{
...
router.get('/usuarios/listarAlumnos', auth, async (req, res) => {    
    try{
